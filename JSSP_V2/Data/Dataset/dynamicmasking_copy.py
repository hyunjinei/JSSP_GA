...
class DQNAgent:
    def __init__(self, max_state_size, action_size, update_target_frequency=100, replay_start_size=1000):
...
class TaskAgent(DQNAgent):
    def __init__(self, max_state_size, action_size, gnn, update_target_frequency=1000, replay_start_size=1000):
...
def train_individual_models(datasets):
    ...
    for i, dataset in enumerate(datasets):
        ...
        task_agent = TaskAgent(max_state_size, action_size, gnn, update_target_frequency=100, replay_start_size=1000)
        machine_agent = MachineAgent(max_state_size, action_size, gnn, update_target_frequency=100, replay_start_size=1000)
        repeat_count = 100  # 충분한 반복 횟수로 설정
