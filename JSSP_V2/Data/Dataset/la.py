...
class Dataset:
    def __init__(self):
        ...
        if __name__ == "__main__":
            file_path = os.path.join(os.getcwd(),'la02.txt')
        else:
            file_path = os.path.join(os.path.dirname(__file__),'la02.txt')
        ...
        # Set Solution Data
        self.solution_list = []
        solution_path = os.path.join(os.path.dirname(__file__), 'la02_solutions.txt')
