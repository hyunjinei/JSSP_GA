...
class GAEngine:
    def __init__(self, config, op_data, crossover, mutation, selection, local_search, elite_ratio=0.1, ga_engines=None, island_mode=None, migration_frequency=None, initialization_mode=1):
        self.config = config
        ...
        self.population = Population(config, op_data, initialization_mode)
        self.best_time = None
