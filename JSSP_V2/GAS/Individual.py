...
class Individual:
    ...
    def calculate_makespan(self, return_times=False):
        completion_times = [[0 for _ in range(self.config.n_machine)] for _ in range(len(self.seq))]
        ...
        self.makespan = completion_times[-1][-1]  # 항상 makespan 업데이트
