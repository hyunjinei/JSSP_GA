...
def main():
    ...
    config = Run_Config(n_job=10, n_machine=10, n_op=100, population_size=20, generations=20, 
    ...
    custom_settings = [
        ...
        {'crossover': OrderCrossover, 'pc': 0.8, 'mutation': GeneralMutation, 'pm': 0.1, 'selection': TournamentSelection(), 'local_search': HillClimbing(), 'pso': None, 'selective_mutation': SelectiveMutation(pm_high=0.8, pm_low=0.01, rank_divide=0.5)}, 
