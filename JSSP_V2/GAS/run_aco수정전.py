...
def main():
    ...
    config = Run_Config(n_job=10, n_machine=10, n_op=100, population_size=200, generations=100, 
    ...
    custom_settings = [
        # {'crossover': PMXCrossover, 'pc': 0.7, 'mutation': InversionMutation, 'pm': 0.9, 'selection': TournamentSelection(), 'local_search': SimulatedAnnealing()},
        ...
        # {'crossover': OBC, 'pc': 0.7, 'mutation': InversionMutation, 'pm': 0.9, 'selection': TournamentSelection(), 'local_search': SimulatedAnnealing()},
