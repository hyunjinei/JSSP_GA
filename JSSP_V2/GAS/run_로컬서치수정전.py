...
def main():
    ...
    config = Run_Config(n_job=3, n_machine=3, n_op=9, population_size=200, generations=20, 
    ...
    custom_settings = [
        ...
        {'crossover': OrderCrossover, 'pc': 0.8, 'mutation': GeneralMutation, 'pm': 0.1, 'selection': TournamentSelection(), 'local_search': TabuSearch(), 'pso': None, 'selective_mutation': SelectiveMutation(pm_high=0.8, pm_low=0.01, rank_divide=0.5)}, 
