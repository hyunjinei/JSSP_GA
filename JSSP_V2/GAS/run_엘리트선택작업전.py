...
def main():
    ...
    config = Run_Config(n_job=10, n_machine=10, n_op=100, population_size=50, generations=100, 
    ...
    custom_settings = [
        {'crossover': PMXCrossover, 'pc': 0.6, 'mutation': DisplacementMutation, 'pm': 0.8, 'selection': RouletteSelection(), 'local_search': None},
