...
MIGRATION_FREQUENCY = 3  # Migration frequency 설정
...
def main():
    ...
    '''
    custom_settings = [
        {'crossover': PositionBasedCrossover, 'pc': 0.8, 'mutation': SwapMutation, 'pm': 0.1, 'selection': TournamentSelection(), 'local_search': [SimulatedAnnealing(),GifflerThompson_LS(priority_rule=None),TabuSearch()], 'pso':  None, 'selective_mutation': SelectiveMutation(pm_high=0.5, pm_low=0.01, rank_divide=0.4)},
        {'crossover': PositionBasedCrossover, 'pc': 0.8, 'mutation': InsertionMutation, 'pm': 0.1, 'selection': SeedSelection(), 'local_search': [SimulatedAnnealing(),GifflerThompson_LS(priority_rule=None)], 'pso':  None, 'selective_mutation': SelectiveMutation(pm_high=0.5, pm_low=0.01, rank_divide=0.4)},
        {'crossover': SXX, 'pc': 0.8, 'mutation': InsertionMutation, 'pm': 0.1, 'selection': TournamentSelection(), 'local_search': [GifflerThompson_LS(priority_rule=None),SimulatedAnnealing()], 'pso':  None, 'selective_mutation': SelectiveMutation(pm_high=0.5, pm_low=0.01, rank_divide=0.4)},
        {'crossover': OBC, 'pc': 0.8, 'mutation': SwapMutation, 'pm': 0.1, 'selection': SeedSelection(), 'local_search': [SimulatedAnnealing(), TabuSearch()], 'pso':  None, 'selective_mutation': SelectiveMutation(pm_high=0.5, pm_low=0.01, rank_divide=0.4)},
    ]
