...
def main():
    ...
    config = Run_Config(n_job=3, n_machine=3, n_op=9, population_size=30, generations=10, 
    ...
    custom_settings = [
        {'crossover': PMXCrossover, 'pc': 0.3, 'mutation': DisplacementMutation, 'pm': 0.9, 'selection': RouletteSelection(), 'local_search': None},
